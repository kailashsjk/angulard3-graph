...
/* MIT license */
	...
	var myChart = new Chart(ctx, {
	  type: 'pie',
	  data: {
	    labels: ["Sedan", "Sports Car", "Convertible", "Compact Car", "Medium SUV", "Small SUV", "Hybrid","Family Saloon","Coupe","Large SUV","Station Wagon"],
	    datasets: [{
	      backgroundColor: [
	        "#2ecc71",
	        "#3498db",
	      ...
	      data: [5563, 1934, 2005, 2074, 1776, 2089,5681,5299,1855,3529,3747]
	    }]
	  }
	});
